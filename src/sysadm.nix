{
  ...
  skills = [
    ...
    {
      name = "Scripting";
      keywords = ["PowerShell" "Bash" "Zsh" "Nushell" "Python"];
    }
    {
      name = "Deployment";
      keywords = ["Kubernetes" "Containers" "GitHub Actions" "Ansible"];
    }
    {
      name = "Nix";
